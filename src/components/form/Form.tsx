...
export const CustomForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <a href="#" className="block text-xs text-right pr-12 text-[#242155] md:text-base md:pr-24 md:mt-4 lg:text-sm lg:pr-34 lg:mt-4">Forgot Password?</a>
      {/* Button Submit */}
      <button type="submit" className="block w-[80%] mx-auto mt-4 py-1 font-semibold rounded-4xl border border-[#242155] bg-white text-[#242155] md:w-[50%] md:mt-8 md:py-3 md:text-lg lg:w-[60%] lg:mt-4 lg:py-2 lg:text-base lg:font-bold">Login</button>
    </form>
  )
}